...
![](img/Openscapes_ESIP10min_2022_01_180.png)

# Community Building Lessons from the NASA Openscapes Framework

![](img/Openscapes_ESIP10min_2022_01_181.png)

![](img/Openscapes_ESIP10min_2022_01_182.png)
...
[Founder & Co-Director, Openscapes]{style="color:#5E696C"}

[National Center for Ecological Analysis and Synthesis (NCEAS), UC Santa Barbara (UCSB)]{style="color:#5E696C"}
...
![](img/Openscapes_ESIP10min_2022_01_183.png)

![](img/Openscapes_ESIP10min_2022_01_184.png)

# openscapes.org

@openscapes

![](img/Openscapes_ESIP10min_2022_01_185.png)

[Award \# 20-TWSC20-2-0003]{style="color:#595959"}

![](img/Openscapes_ESIP10min_2022_01_186.png)
...
![](img/Openscapes_ESIP10min_2022_01_187.png)
...
![](img/Openscapes_ESIP10min_2022_01_188.png)

![](img/Openscapes_ESIP10min_2022_01_189.jpg)
...
![](img/Openscapes_ESIP10min_2022_01_1810.png)

![](img/Openscapes_ESIP10min_2022_01_1811.png)

![](img/Openscapes_ESIP10min_2022_01_1812.png)
...
![](img/Openscapes_ESIP10min_2022_01_1813.png)

![](img/Openscapes_ESIP10min_2022_01_1814.png)
...
![](img/Openscapes_ESIP10min_2022_01_1817.png)

![](img/Openscapes_ESIP10min_2022_01_1818.png)

![](img/Openscapes_ESIP10min_2022_01_1819.png)
...
![](img/Openscapes_ESIP10min_2022_01_1820.png)
...
![](img/Openscapes_ESIP10min_2022_01_1821.png)

![](img/Openscapes_ESIP10min_2022_01_1822.png)

![](img/Openscapes_ESIP10min_2022_01_1823.png)

![](img/Openscapes_ESIP10min_2022_01_1824.png)

![](img/Openscapes_ESIP10min_2022_01_1825.png)

![](img/Openscapes_ESIP10min_2022_01_1826.png)

[[*https://nasa-openscapes.github.io*]{style="color:#595959"}](https://nasa-openscapes.github.io)

![](img/Openscapes_ESIP10min_2022_01_1827.png)

[*Empower*]{style="color:#45818E"} [**Research Teams**]{style="color:#45818E"}

![](img/Openscapes_ESIP10min_2022_01_1828.png)
...
![](img/Openscapes_ESIP10min_2022_01_1829.png)

![](img/Openscapes_ESIP10min_2022_01_1830.png)
...
# How would you rate your comfort level working with NASA Earthdata data and services in the cloud, before/after the Cloud Hackathon?

# Before

# After

![](img/Openscapes_ESIP10min_2022_01_1831.png)

![](img/Openscapes_ESIP10min_2022_01_1832.png)

![](img/Openscapes_ESIP10min_2022_01_1833.png)

![](img/Openscapes_ESIP10min_2022_01_1834.png)

[*Support from participants:*]{style="color:#646363"} [*It's worth investing the extra time required to become familiar with cloud computing and the newer python libraries to access and manipulate satellite data. The few hundred lines of code I wrote this week will replace several thousand lines of old code using just numpy! It's also a heck of a lot easier to read and use.*]{style="color:#646363"}

[*More work to do:*]{style="color:#646363"} [*The tutorials were fantastic, but I struggled to figure out when to use the various methods we learned in the tutorials.*]{style="color:#646363"}

![](img/Openscapes_ESIP10min_2022_01_1835.png)

Tooling & norms for co-creating

![](img/Openscapes_ESIP10min_2022_01_1836.png)
...
![](img/Openscapes_ESIP10min_2022_01_1837.png)
...
![](img/Openscapes_ESIP10min_2022_01_1838.png)

![](img/Openscapes_ESIP10min_2022_01_1839.png)
...
![](img/Openscapes_ESIP10min_2022_01_1840.png)

![](img/Openscapes_ESIP10min_2022_01_1841.png)
...
[**Thank you to the**]{style="color:#D86D4C"}

[**DAAC Mentors!**]{style="color:#D86D4C"}

![](img/Openscapes_ESIP10min_2022_01_1842.png)
...
![](img/Openscapes_ESIP10min_2022_01_1843.png)

![](img/Openscapes_ESIP10min_2022_01_1844.png)

![](img/Openscapes_ESIP10min_2022_01_1845.png)

![](img/Openscapes_ESIP10min_2022_01_1846.png)

![](img/Openscapes_ESIP10min_2022_01_1847.png)

![](img/Openscapes_ESIP10min_2022_01_1848.png)

![](img/Openscapes_ESIP10min_2022_01_1849.png)

# Thank you!

We're looking forward to working together!

![](img/Openscapes_ESIP10min_2022_01_1850.png)

![](img/Openscapes_ESIP10min_2022_01_1851.png)

![](img/Openscapes_ESIP10min_2022_01_1852.png)

![](img/Openscapes_ESIP10min_2022_01_1853.png)
...
![](img/Openscapes_ESIP10min_2022_01_1854.png)

# NASA Earthdata Cloud Resources

![](img/Openscapes_ESIP10min_2022_01_1855.png)

![](img/Openscapes_ESIP10min_2022_01_1856.png)

![](img/Openscapes_ESIP10min_2022_01_1857.png)

![](img/Openscapes_ESIP10min_2022_01_1858.png)
...
![](img/Openscapes_ESIP10min_2022_01_1859.png)
...
![](img/Openscapes_ESIP10min_2022_01_1860.png)

![](img/Openscapes_ESIP10min_2022_01_1861.png)

![](img/Openscapes_ESIP10min_2022_01_1862.png)

![](img/Openscapes_ESIP10min_2022_01_1863.png)
...
![](img/Openscapes_ESIP10min_2022_01_1864.png)
...
![](img/Openscapes_ESIP10min_2022_01_1865.png)
...
![](img/Openscapes_ESIP10min_2022_01_1866.png)
...
![](img/Openscapes_ESIP10min_2022_01_1867.png)

# Success Stories

![](img/Openscapes_ESIP10min_2022_01_1868.png)
